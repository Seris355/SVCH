    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content detail-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="detail-content">
          ...
          <div className="detail-field">
            <label>Дата:</label>
            <span>{new Date(masterClass.date).toLocaleString('ru-RU')}</span>
          </div>
          ...
          {masterClass.createdAt && (
            <div className="detail-field">
              <label>Дата создания:</label>
              <span>{new Date(masterClass.createdAt).toLocaleString('ru-RU')}</span>
            </div>
          )}

          {masterClass.updatedAt && (
            <div className="detail-field">
              <label>Дата обновления:</label>
              <span>{new Date(masterClass.updatedAt).toLocaleString('ru-RU')}</span>
            </div>
          )}
        </div>
